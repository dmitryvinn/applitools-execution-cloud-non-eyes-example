        ...
        const handle = {
          ...
          async start() {
            ...
            try {
              ...
              if (handle.running || !types5.instanceOf(error, "AbortError"))
...
async function req(input, ...requestOptions) {
  ...
  async function req2(input2, options2) {
    ...
    const fetch2 = (_a4 = options2.fetch) !== null && _a4 !== void 0 ? _a4 : fetch;
    if (options2.signal)
      options2.signal.onabort = () => controller.abort();
    ...
    const extraHeaders = {};
    if (utils2.types.isPlainObject(options2.body) || utils2.types.isArray(options2.body) || options2.body === null) {
    ...
    let request = new Request(url, {
      ...
      agent: makeProxyAgent(options2.proxy),
      signal: controller.signal
    });
    request = await beforeRequest({ request, options: options2 });
    try {
      let response = await fetch2(request);
      const retry = await ((_g = options2.retry) === null || _g === void 0 ? void 0 : _g.reduce(async (prev, retry2) => {
        var _a5, _b2;
      ...
      const retry = await ((_k = options2.retry) === null || _k === void 0 ? void 0 : _k.reduce((prev, retry2) => {
